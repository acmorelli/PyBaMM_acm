"""
CCPM half-cell test: Li metal || LFP  —  2C CHARGE with core-shell solid diffusion.
...
parameter_values.update(
    {
        ...
        # Start fully lithiated (θ ≈ 1) for charge (delithiation)
        "Initial concentration in positive electrode [mol.m-3]": 0.996 * 22806.0,
...
print("Building & solving half-cell CCPM (core-shell, 2C charge) …")
solution = sim.solve()
sim.save("half_cell_omega_2c_charge_core_shell.pkl")
print("Done.\n")
...
fig.suptitle("Core-shell 2C charge")
...
plt.savefig("half_cell_charge_omega_2c_core_shell.png", dpi=150)
print("\nPlot saved to half_cell_charge_omega_2c_core_shell.png")

from postprocess_half_cell_fig7 import plot_fig7
fig7 = plot_fig7(sol_chg=solution, save_path="half_cell_charge_omega_2c_core_shell_fig7.png")
plt.show()
plt.close(fig7)
