...
experiment = pybamm.Experiment([
    "Discharge at C/30 for 5s",    #3.25V
])
...
fig2.update_yaxes(title_text="density", row=3, col=1)
fig2.update_xaxes(title_text="c_p / c_{p,max}", row=3, col=1)
