...
# PyBaMM convention: negative current = charge
CURRENT_A = -4.0

# Since theta_init is extremely low, you may need long times to reach c_sp1
T_END = 20000.0
T_END= 200
N_T = 3

# Debug-only relaxed cutoffs so the simulation does not stop early
LOWER_CUTOFF_V = 2.0
UPPER_CUTOFF_V = 5.0
